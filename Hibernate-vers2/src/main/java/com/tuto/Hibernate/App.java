...
public class App {
    ...
    public static void main( String[] args ){
    	...
    	invoice4.setProductQuantity(productList1);
    	...
    	invoiceList2.add(invoice4);
    	
    	
    	oussema.setInvoices(invoiceList);
    	personne.setInvoices(invoiceList2);
    	
    	customerDao.saveCustomer(oussema);
    	customerDao.saveCustomer(personne);	
       
        
    	System.out.println( "Le client "+ customerDao.showCustomer(1L) );
    	System.out.println( "Le client "+ customerDao.showCustomer(2L) );
